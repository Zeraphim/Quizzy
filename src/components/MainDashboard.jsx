  ...
  return (
    <div className="h-screen w-screen text-white text-4xl font-bold flex items-center justify-center">
      <div className="grid grid-rows-4 grid-flow-col gap-4">
        {/* Question Banks */}
        <div className="col-span-2 row-span-2 flex items-center justify-center w-[35vw] h-[40vh] backdrop-blur-sm gap-6 bg-white rounded-3xl overflow-hidden bg-opacity-10 border-2 border-opacity-[4%] border-white z-40">Question Banks</div>
        {/* Math Banks */}
